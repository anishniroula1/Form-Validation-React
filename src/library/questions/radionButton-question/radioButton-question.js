  ...
  return (
    <div>
      <div
        className={
          question.error
            ? 'radioButton-question__error-formGroup'
            : 'radioButton-question__formGroup'
        }
      >
        <label
          className={
            question.error
              ? 'radioButton-question__error-label'
              : 'radioButton-question__label'
          }
        >
          {question.label}:
        </label>
        <div className='radioButton-question__container'>
          {question.data.map((item, key) => (
            <div key={key}>
              <label>
                <input
                  className='radioButton-question__input'
                  type='radio'
                  name={question.key}
                  value={item.value}
                  onChange={onChange}
